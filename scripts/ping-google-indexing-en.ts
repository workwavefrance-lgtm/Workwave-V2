...
// ⚠️ workwaveai.co est le domaine PROPRE de Workwave AI EN. Les routes /en/ai/* sur
// workwave.fr sont en 308 → workwaveai.co. Pinger workwave.fr/en/ai/* à Google
// produit un signal "Page avec redirection" (= non-indexable), pas une indexation
