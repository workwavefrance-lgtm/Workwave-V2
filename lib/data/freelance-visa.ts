...
export const VISA_GUIDES: Record<string, VisaGuide> = {
  ...
  "saudi-arabia": {
    ...
    eligibility:
      "The Freelance Work Document is reserved for Saudi nationals (typically aged 18 to 60). Expatriates generally cannot obtain it and must instead use a MISA investment licence or Premium Residency. Working as an undocumented 'freelancer' as a foreigner is treated as a serious commercial-concealment ('Tasattur') violation.",
    issuers:
  ...
  qatar: {
    ...
    validity: "Mustaqel: 5 years, renewable. Standard work/residence permits: 1 to 2 years.",
    caveats: [
