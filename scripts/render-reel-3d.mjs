...
const OUT = process.env.REEL_FRAMES_DIR || path.join(os.tmpdir(), "workwave-frames-3d");
...
await page.goto("http://localhost:8877/reel-3d-render.html", { waitUntil: "networkidle0" });
