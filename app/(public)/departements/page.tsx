...
// Page hub : liste les 12 departements de Nouvelle-Aquitaine avec liens vers
...
export const metadata: Metadata = {
  title: "Professionnels par département en Nouvelle-Aquitaine - Workwave",
  description:
    "Annuaire des artisans et professionnels par département en Nouvelle-Aquitaine. Plus de 226 000 pros référencés en Charente, Charente-Maritime, Corrèze, Creuse, Dordogne, Gironde, Landes, Lot-et-Garonne, Pyrénées-Atlantiques, Deux-Sèvres, Vienne, Haute-Vienne.",
  alternates: {
    canonical: `${BASE_URL}/departements`,
  },
  openGraph: {
    type: "website",
    title: "Professionnels par département en Nouvelle-Aquitaine",
    description:
      "Annuaire des artisans par département en Nouvelle-Aquitaine. 226 000 pros référencés dans les 12 départements.",
...
export default async function DepartmentsHubPage() {
  ...
  // On fait les 12 queries en parallele.
    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-[var(--text-secondary)] max-w-3xl">
          Plus de 226 000 artisans et professionnels référencés dans les 12
          départements de Nouvelle-Aquitaine. Choisissez votre département pour
      ...
      <section className="mt-16 pt-8 border-t border-[var(--border-color)]">
        ...
        <p className="text-[var(--text-secondary)] max-w-3xl leading-relaxed">
          Workwave référence gratuitement plus de 226 000 professionnels en
          Nouvelle-Aquitaine, issus du registre Sirene. Notre annuaire couvre
          les 12 départements de la région avec les principaux corps de métier
