...
/**
 * Signup success page EN : /en/ai/inscription/succes.
 *
 * Atterrissage apres submitInscription (champ cache locale=en). Lit ?id= et
 * ?plan= comme la page FR. EN = plan gratuit uniquement, donc plan affiche
 * toujours "Free".
 *
 * noindex : page de confirmation, pas SEO.
 */
...
export default async function InscriptionSuccesEnPage({
  searchParams,
}: {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 w-full">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-[var(--ai-text-secondary)] leading-relaxed mb-10 max-w-xl mx-auto">
            Your Workwave AI freelancer account is live. The moment a tech
            project is posted, you get an email in real time. Sign in to your
            dashboard to see every project and filter by skill.
          </p>
          ...
          <div className="bg-[var(--ai-bg-card)] border border-[var(--ai-border-subtle)] rounded-2xl p-8 mb-10 text-left max-w-md mx-auto">
            ...
            <ul className="space-y-3 text-[13px] text-[var(--ai-text-secondary)] leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>Welcome email sent to your address (check your spam folder).</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[var(--ai-accent)] mt-0.5 flex-shrink-0 font-bold">02</span>
                <span>Sign in to your dashboard via /en/ai/connexion (6-digit code sent by email).</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[var(--ai-accent)] mt-0.5 flex-shrink-0 font-bold">03</span>
                <span>Complete your profile (bio, stack, GitHub, LinkedIn) to earn badges.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[var(--ai-accent)] mt-0.5 flex-shrink-0 font-bold">04</span>
                <span>Get EVERY tech project posted, in real time, by email + dashboard.</span>
              </li>
            </ul>
          </div>
